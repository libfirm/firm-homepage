...
Please respect the link:Coding_Conventions.html[Coding Conventions]
...
Make your life a little easier and use the link:Debug_Extension.html[Debug Extension]. Make sure you grab the .gdbinit file from that site.
